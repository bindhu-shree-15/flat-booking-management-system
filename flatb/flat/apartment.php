...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <body style="background-image:url('img/6.jpg'); background-size: cover; background-repeat: no-repeat;"linear-gradient(to right, #3E5151 , #DECBA4);">
     ...
     ?>
       ...
       <div style="width: 400px;margin-left:4%;margin-top: 1.5%;box-shadow: 0px 0px 5px #27ae60;padding:20px">
        <div style='text-align: center;padding:20px;background:  linear-gradient(To top right,#033,#3cc);color:white;border-radius: 25% 25% 0% 0%'>Enter Flat</div>
    ...
    <label class="control-label col-sm-1" for="apartment">Flat:</label>
    <div class="col-sm-10" style="margin-top:30px">
        <input type="text" class="form-control" name="apartment" required="" pattern="[0-9]{3}" placeholder="Flat Number" value="<?php echo $aname;?>"/><br>
    </div>
            </div>
    ...
    <div class="col-sm-10" style="margin-top:0.1px">
        ...
        <table class="table table-hover table-condensed" style="margin-top: 5%">
            ...
            $(document).ready(function() {
                ...
                if(msg){
                    alert("Flat Number already Exist.");
                }
                if(updatedmsg){
                    alert("Flat Records Updated.");
                }
            });
        </script>
    </body>
