...
<nav class="navbar navbar-default navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">Flat Booking</a>
    </div>
    <ul class="nav navbar-nav pull-right">

      <li><a href="index.php">Developer Login</a></li>
      <li><a href="ologin.php">Owner Login</a></li>
      <li class="active"><a href="tlogin.php">Customer Login</a></li>
    </ul>
  </div>
</nav>
...
<div class="container">
    ...
    <div style="width: 400px;margin-left: 35%;//box-shadow: 0px 0px 5px #660066;//padding:20px;">
        <div style='text-align: center;padding:15px;color:#2f3542;background-image:linear-gradient( white , #2c3e50);font-family: serif; //border-radius: 15% 25% 0% 25%'><b><h2>Customer Login</b></h2></div>
